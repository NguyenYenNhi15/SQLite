...
import com.sqlite.adapter.ViewPagerAdapter;
...
public class UpdateDeleteActivity extends AppCompatActivity implements View.OnClickListener {
	...
	private void initView() {
		...
		sp.setAdapter(new ArrayAdapter<String>(this,R.layout.item_spinner,getResources().getStringArray(R.array.catergory)));
	}
	...
	public void onClick(View view) {
		...
		if (view==btRemove){
			...
			builder.setMessage("Bạn có muốn xóa "+item.getTitle()+" không?");
